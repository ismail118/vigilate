...
func (repo *DBRepo) AllHealthyServices(w http.ResponseWriter, r *http.Request) {
	// get all host_services with host info for status pending
	hosts, err := repo.DB.GetServicesByStatus("healthy")
	if err != nil {
		log.Println(err)
		return
	}
...
func (repo *DBRepo) AllWarningServices(w http.ResponseWriter, r *http.Request) {
	// get all host_services with host info for status pending
	hosts, err := repo.DB.GetServicesByStatus("warning")
	if err != nil {
		log.Println(err)
		return
	}
...
func (repo *DBRepo) AllProblemServices(w http.ResponseWriter, r *http.Request) {
	// get all host_services with host info for status pending
	hosts, err := repo.DB.GetServicesByStatus("problem")
	if err != nil {
		log.Println(err)
		return
	}
...
func (repo *DBRepo) AllPendingServices(w http.ResponseWriter, r *http.Request) {
	// get all host_services with host info for status pending
	hosts, err := repo.DB.GetServicesByStatus("pending")
	if err != nil {
		log.Println(err)
		return
	}
